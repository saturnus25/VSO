# VSO7 1.2.0 — Technical User Guide and Functional Reference
...
The source and catalogs take precedence if a later version contradicts this guide. Menu numbers apply to VSO7 1.2.0.
...
This subsection preserves the user-oriented explanations from the initial documentation and cross-checks them against the `FeatureId` and metadata in the VSO7 1.2.0 catalog. The technical matrix above remains authoritative for applicability, relationships, operations, and Recovery. This guide explains in direct language what each tweak does, when it makes sense, and what the user may lose.
